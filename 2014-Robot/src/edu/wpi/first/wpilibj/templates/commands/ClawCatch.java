...
/**
 *
 * This class moves the claw from its current position into catching position,
 * i.e. the very top of the robot. To do this, the claw moves backward until it
 * reaches the minimum position defined in the claw Pitch subsystem
 *
 * @author Lauren
 */
